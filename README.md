...
| File                                                                      | Description |
|---------------------------------------------------------------------------|-------------|
| [`randomplz_match_and_replace.py`](src/main/resources/examples/randomplz_match_and_replace.py) | Match and replace a random string with a blind XSS payload for xsshunter-go correlation |
